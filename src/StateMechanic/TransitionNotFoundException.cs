...
namespace StateMechanic
{
    ...
    public class TransitionNotFoundException : Exception
    {
        ...
        internal TransitionNotFoundException(IEvent @event)
            : base(String.Format("Event {0} has not been associated with any transitions, and could not be invoked", @event.Name))
        {
            this.Event = @event;
        }
