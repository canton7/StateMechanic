...
{
    internal interface IInternalTransitionInfo<TState> : ITransitionInfo<TState>
    {
        IInternalTransitionInfo<TState> WithFromState(TState from);
        IInternalTransitionInfo<TState> WithToState(TState to);
    }
